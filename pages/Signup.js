...
<div className="bg-white shadow rounded-2xl lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
            ...
            <div className="w-full flex items-center justify-between py-5">
                ...
                <div className="mt-8">
                    <button
                    onClick={submit}
                    role="button" className=" focus:ring-indigo-700 text-sm font-semibold leading-none text-white  bg-gradient-to-r from-[#03423E] to-[#0FD6C9] border rounded hover:bg-gradient-to-bl shadow-md py-4 w-full">Create account</button>
                </div>
